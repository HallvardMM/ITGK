...
def main():
    ...
    s.split(',')#Skriv inn kode slik at det bruker har skrevet inn tegnes med de oppgitte spesifikasjonene.
    if s[0]=="m":
        cupcake(s[1],s[2],s[3],s[4])
    elif s[0]=="b":
        flower(s[1],s[2],s[3],s[4])
    elif s[0]=="s":
        chocolate(s[1],s[2],s[3],s[4])
